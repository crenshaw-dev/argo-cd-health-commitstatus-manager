...
require (
	...
	github.com/zachaller/promoter v0.0.0-20240521232752-ff059511f409
...
replace (
	github.com/argoproj/argo-cd/v2 => github.com/crenshaw-dev/argo-cd/v2 v2.0.0-20240522000831-74d4e980f9e0
